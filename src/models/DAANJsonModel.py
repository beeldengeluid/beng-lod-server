...
def isSceneDescription(logtrack_type):
    ...
    return logtrack_type == LogTrackType.SCENE_DESC.value or logtrack_type == LogTrackType.SCENE_DESC2.value or \
           logtrack_type == LogTrackType.SCENE_DESC3.value or logtrack_type == LogTrackType.SCENE_DESC4.value
